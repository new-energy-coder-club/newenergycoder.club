...
const GoogleLogo = 'https://cdn.newenergycoder.club/images/src/assets/google-logo.svg'
const WeChatLogo = 'https://cdn.newenergycoder.club/images/src/assets/wechat.png'
